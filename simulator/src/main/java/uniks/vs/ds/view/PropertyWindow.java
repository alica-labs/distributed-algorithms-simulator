...
import uniks.vs.ds.model.IPropertyDest;
...
public class PropertyWindow extends SfcFrame implements
   ...
   *          the model item
   */
  private PropertyWindow(final ModelBase item) {
    super();
   ...
   * @author Thomas Weise
   */
  private static final class TM extends AbstractTableModel implements
      IPropertyDest {
    /**
     * the serial version uid
     */
