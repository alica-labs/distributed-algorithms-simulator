 ...
 * Original Filename: uniks.vs.de.uniks.vs.ds.view.PropertyWindow.java
 ...
 * @author Thomas Weise
 */
public class PropertyWindow extends SfcFrame implements SimulationListener {
  /**
   ...
   *          the model item
   */
  static final void showProperties(final Model item) {
    int i;
   ...
   *          the model item
   */
  private PropertyWindow(final Model item, Stage stage, Group root) {
      super(stage, root);
...
//    m.fireTableDataChanged();
   ...
   */
  static final void closeSpecificWindow(final Model b) {
    int i;
    PropertyWindow w;
    synchronized (LST) {
      for (i = (LST.size() - 1); i >= 0; i--) {
